...
#if CONFIG_XPRS_BOARD_EPAPER_1IN54
...
/* An external repository, not our naming to change. */
...
static esp_err_t download_binary(const char *url, const char *local_path, size_t *downloaded_size)
{
    ...
    request.user_agent = "XPRS-ESP32/1.0";
...
#else // !CONFIG_XPRS_BOARD_EPAPER_1IN54
...
#endif // CONFIG_XPRS_BOARD_EPAPER_1IN54
