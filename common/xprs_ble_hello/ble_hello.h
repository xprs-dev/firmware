/**
 * @file ble_hello.h
 * @brief Standalone BLE HELLO protocol for XPRS devices.
 *
 * Provides:
 *   - BLE advertising with XPRS manufacturer data (callsign + device ID)
 *   - Passive scanning for nearby XPRS devices (0x3E marker)
 *   - GATT server for HELLO / HELLO_ACK handshake
 *
 * No dependencies on mesh, aprs, radio_tx, or station.
 */

#ifndef XPRS_BLE_HELLO_H
#define XPRS_BLE_HELLO_H
...
/**
 * @brief Number of nearby XPRS devices seen in the last 60 seconds.
 */
