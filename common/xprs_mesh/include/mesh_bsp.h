/**
 * @file mesh_bsp.h
 * @brief XPRS ESP-MESH networking public API
 *
...
#ifndef XPRS_MESH_BSP_H
#define XPRS_MESH_BSP_H
 ...
 */
typedef enum {
    XPRS_MESH_STATUS_STOPPED = 0,    /**< Mesh not started */
    XPRS_MESH_STATUS_STARTED,         /**< Mesh started, scanning */
    XPRS_MESH_STATUS_CONNECTED,       /**< Connected to mesh network */
    XPRS_MESH_STATUS_DISCONNECTED,    /**< Disconnected from mesh */
    XPRS_MESH_STATUS_ROOT,            /**< This node is the root */
    XPRS_MESH_STATUS_ERROR            /**< Error state */
} xprs_mesh_status_t;
 ...
 */
typedef enum {
    XPRS_MESH_EVENT_STARTED,              /**< Mesh started */
    XPRS_MESH_EVENT_STOPPED,              /**< Mesh stopped */
    XPRS_MESH_EVENT_CONNECTED,            /**< Connected to mesh */
    XPRS_MESH_EVENT_DISCONNECTED,         /**< Disconnected from mesh */
    XPRS_MESH_EVENT_ROOT_CHANGED,         /**< Root status changed */
    XPRS_MESH_EVENT_CHILD_CONNECTED,      /**< Child node connected */
    XPRS_MESH_EVENT_CHILD_DISCONNECTED,   /**< Child node disconnected */
    XPRS_MESH_EVENT_ROUTE_TABLE_CHANGE,   /**< Route table updated */
    XPRS_MESH_EVENT_EXTERNAL_STA_CONNECTED,    /**< Phone connected to AP */
    XPRS_MESH_EVENT_EXTERNAL_STA_DISCONNECTED  /**< Phone disconnected */
} xprs_mesh_event_t;
 ...
 */
typedef void (*xprs_mesh_event_cb_t)(xprs_mesh_event_t event, void *event_data);
 ...
 */
void xprs_mesh_bridge_get_stats(uint32_t *packets_tx, uint32_t *packets_rx,
 ...
 */
typedef void (*xprs_mesh_data_cb_t)(const uint8_t *src_mac, const void *data, size_t len);
