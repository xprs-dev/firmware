#ifndef XPRS_MODEL_TDONGLE_S3_CONFIG_H
#define XPRS_MODEL_TDONGLE_S3_CONFIG_H
...
// xprs_sdcard/CMakeLists.txt (it does not include this header); kept here for
...
#endif // XPRS_MODEL_TDONGLE_S3_CONFIG_H
