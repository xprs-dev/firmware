...
static xprs_wifi_status_t s_wifi_status = XPRS_WIFI_STATUS_DISCONNECTED;
static xprs_wifi_event_cb_t s_sta_callback = NULL;
static xprs_wifi_event_cb_t s_ap_callback = NULL;
    ...
    if (event_base == WIFI_EVENT) {
        switch (event_id) {
            case WIFI_EVENT_STA_START:
                ...
                s_wifi_status = XPRS_WIFI_STATUS_CONNECTING;
            ...
            case WIFI_EVENT_STA_CONNECTED:
                ...
                s_wifi_status = XPRS_WIFI_STATUS_CONNECTED;
                ...
                if (s_sta_callback) {
                    s_sta_callback(XPRS_WIFI_STATUS_CONNECTED, event_data);
                }
                break;
            ...
            case WIFI_EVENT_STA_DISCONNECTED: {
                ...
                s_wifi_status = XPRS_WIFI_STATUS_DISCONNECTED;
                s_current_ip = 0;
                ...
                if (s_sta_connecting) {
                    ...
                    if (s_retry_count <= MAX_RETRY_COUNT) {
                        ...
                        if (s_retry_count == MAX_RETRY_COUNT + 1) {
                            ...
                            if (s_sta_callback) {
                                s_sta_callback(XPRS_WIFI_STATUS_DISCONNECTED, event_data);
                            }
                        }
                    }
                    if (s_hold_reconnect) {
            ...
            case WIFI_EVENT_AP_START:
                ...
                s_ap_active = true;
                s_wifi_status = XPRS_WIFI_STATUS_AP_STARTED;
                if (s_ap_callback) {
                    s_ap_callback(XPRS_WIFI_STATUS_AP_STARTED, event_data);
                }
                break;
            ...
            case WIFI_EVENT_AP_STACONNECTED:
                ...
                if (s_ap_callback) {
                    s_ap_callback(XPRS_WIFI_STATUS_AP_STACONNECTED, event_data);
                }
                break;
        ...
        if (event_id == IP_EVENT_STA_GOT_IP) {
            ...
            s_wifi_status = XPRS_WIFI_STATUS_GOT_IP;
            if (s_sta_callback) {
                s_sta_callback(XPRS_WIFI_STATUS_GOT_IP, event_data);
            }
        }
    }
}
