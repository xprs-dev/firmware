...
"\n"
"// ---- receiving ----\n"
"// A chat shows people talking. Machine payloads also travel as t:message\n"
"// (announce digests and the like): no spaces, pipes, long hashes. Skip them.\n"
"function isMachine(text){\n"
"  if(text.indexOf('|')>=0&&text.indexOf(' ')<0)return true;\n"
"  if(text.length>40&&text.indexOf(' ')<0)return true;\n"
"  return false;}\n"
"var seen={};\n"
"function render(row){\n"
"  var w=row.wire||'';\n"
