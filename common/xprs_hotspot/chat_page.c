...
"  var wire=signWire('t:message f:'+mycall+' ts:'+tsNow()+where+thread+' m:'+text);\n"
...
"  return r==='local'?'Local':r==='global'?'Global':r.slice(3);}\n"
"function renderSide(){\n"
...
"    r==='global'?'Message (goes everywhere)':'Message to '+r.slice(3);\n"
"}\n"
...
"          var t=rows[i].type||'';\n"
"          if(t==='message'||t==='reaction')render(rows[i]);\n"
"        }\n"
