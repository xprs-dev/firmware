...
".msg .reply-btn{background:transparent;border:0;color:var(--muted);\n"
...
"  var rbtn='<button class=\"reply-btn\" title=\"Reply\">&#8617;</button>';\n"
"  if(own){\n"
"    d.innerHTML='<div class=\"bubble\"></div>'+\n"
"      '<div class=\"meta under\"><span class=\"time\">'+when+'</span>'+badge+rbtn+'</div>';\n"
"  }else{\n"
"    d.innerHTML='<div class=\"meta\"><span class=\"author\"></span>'+\n"
"      '<span class=\"time\">'+when+'</span>'+badge+rbtn+'</div>'+\n"
...
"  }\n"
"  d.querySelector('.reply-btn').onclick=function(){startReply(id);};\n"
