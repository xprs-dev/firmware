...
/**
 * @brief 6x8 pixel font for ASCII characters 32-127
 *
 * Each character is 6 bytes wide (6 columns), 8 pixels tall.
 * Bit 0 is the top pixel, bit 7 is the bottom pixel.
 * 96 characters * 6 bytes = 576 bytes total.
 */
static const uint8_t ssd1306_font_6x8[96][6] = {
    ...
    { 0x7F, 0x7F, 0x7F, 0x7F, 0x7F, 0x00 },  // 127 DEL (block)
};
